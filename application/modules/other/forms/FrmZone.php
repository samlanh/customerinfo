...
Class Other_Form_FrmZone extends Zend_Dojo_Form {
	...
	public function FrmAddZone($_data=null){
		...
		$_title_zone= new Zend_Dojo_Form_Element_TextBox('title_zone');
		$_title_zone->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_title_zone_kh= new Zend_Dojo_Form_Element_TextBox('title_zone_kh');
		$_title_zone_kh->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_note_zone = new Zend_Dojo_Form_Element_Textarea('note_zone');
		$_note_zone->setAttribs(array('dojoType'=>'dijit.form.Textarea','class'=>'fullside',
				'style'=>'width:99%;min-height:50px;'));
