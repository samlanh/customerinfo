<?php 
Class Group_Form_FrmProduct extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmAddProduct($_data=null){
		...
		////for Popup Form////
		$_title_product= new Zend_Dojo_Form_Element_TextBox('title_product');
		$_title_product->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_title_product_kh= new Zend_Dojo_Form_Element_TextBox('title_product_kh');
		$_title_product_kh->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_note_product = new Zend_Dojo_Form_Element_Textarea('note_product');
		$_note_product->setAttribs(array('dojoType'=>'dijit.form.Textarea','class'=>'fullside',
				'style'=>'width:99%;min-height:50px;'));
