<?php 
Class Group_Form_FrmCategory extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmAddCategory($_data=null){
		...
		$_title_category= new Zend_Dojo_Form_Element_TextBox('title_category');
		$_title_category->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_title_category_kh= new Zend_Dojo_Form_Element_TextBox('title_category_kh');
		$_title_category_kh->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_note_category = new Zend_Dojo_Form_Element_Textarea('note_category');
		$_note_category->setAttribs(array('dojoType'=>'dijit.form.Textarea','class'=>'fullside',
				'style'=>'width:99%;min-height:50px;'));
		if(!empty($_data)){
