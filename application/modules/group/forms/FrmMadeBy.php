<?php 
Class Group_Form_FrmMadeBy extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmaddMadeBy($_data=null){
		...
		////for Popup Form////
		$_title_madeby= new Zend_Dojo_Form_Element_TextBox('title_madeby');
		$_title_madeby->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_title_madeby_kh= new Zend_Dojo_Form_Element_TextBox('title_madeby_kh');
		$_title_madeby_kh->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_note_madeby = new Zend_Dojo_Form_Element_Textarea('note_madeby');
		$_note_madeby->setAttribs(array('dojoType'=>'dijit.form.Textarea','class'=>'fullside',
				'style'=>'width:99%;min-height:50px;'));
