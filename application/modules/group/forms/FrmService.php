<?php 
Class Group_Form_FrmService extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmAddService($_data=null){
		...
		$_title_service= new Zend_Dojo_Form_Element_TextBox('title_service');
		$_title_service->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_title_service_kh= new Zend_Dojo_Form_Element_TextBox('title_service_kh');
		$_title_service_kh->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_note_service = new Zend_Dojo_Form_Element_Textarea('note_service');
		$_note_service->setAttribs(array('dojoType'=>'dijit.form.Textarea','class'=>'fullside',
				'style'=>'width:99%;min-height:50px;'));
