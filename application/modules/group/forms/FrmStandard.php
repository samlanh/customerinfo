<?php 
Class Group_Form_FrmStandard extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmAddStandard($_data=null){
		...
		////for Popup Form////
		$_title_standard= new Zend_Dojo_Form_Element_TextBox('title_standard');
		$_title_standard->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_title_standard_kh= new Zend_Dojo_Form_Element_TextBox('title_standard_kh');
		$_title_standard_kh->setAttribs(array('dojoType'=>$this->tvalidate,'required'=>'true','class'=>'fullside',));
		
		$_note_standard = new Zend_Dojo_Form_Element_Textarea('note_standard');
		$_note_standard->setAttribs(array('dojoType'=>'dijit.form.Textarea','class'=>'fullside',
				'style'=>'width:99%;min-height:50px;'));
		if(!empty($_data)){
