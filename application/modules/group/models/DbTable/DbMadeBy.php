...
class Group_Model_DbTable_DbMadeBy extends Zend_Db_Table_Abstract
{

    protected $_name = 'crm_made_by';
    public function getUserId(){
    	$session_user=new Zend_Session_Namespace(SYSTEM_SES);
    	return $session_user->user_id;
    }
	public function addMadeBy($_data){
		$db = $this->getAdapter();
    	$db->beginTransaction();
    	try{
			$_arr=array(
	...
	function getAllMadeBy($search=null){
		$db = $this->getAdapter();
		$sql = "SELECT
				id,
				title,
